...
import com.orhotech.advanceswiperefreshlayout.AdvanceSwipeRefreshLayout;
...
/**
 * Component preliminary implementation
 * When implementing Header and Footer, you can save a lot of interface methods by inheriting SimpleComponent.
...
public abstract class SimpleComponent extends RelativeLayout implements RefreshComponent {
    ...
    public SpinnerStyle getSpinnerStyle() {
        ...
        if (mWrappedView != null) {
            ...
            if (params instanceof AdvanceSwipeRefreshLayout.LayoutParams) {
                mSpinnerStyle = ((AdvanceSwipeRefreshLayout.LayoutParams) params).spinnerStyle;
                if (mSpinnerStyle != null) {
                    return mSpinnerStyle;
                }
            }
    ...
    public void onInitialized(@NonNull RefreshKernel kernel, int height, int maxDragHeight) {
        if (mWrappedInternal != null && mWrappedInternal != this) {
            ...
            ViewGroup.LayoutParams params = mWrappedView.getLayoutParams();
            if (params instanceof AdvanceSwipeRefreshLayout.LayoutParams) {
                kernel.requestDrawBackgroundFor(this, ((AdvanceSwipeRefreshLayout.LayoutParams) params).backgroundColor);
            }
        }
    }
