...
public class SmartUtil implements Interpolator {
    ...
    //<editor-fold desc="Scroll judgment">

    /**
     * Determine whether the content can be refreshed
     * @param targetView content view
     * @param touch press event position
     * @return whether it can be refreshed
     */
     ...
     * @param targetView content view
     * @param touch press event position
     * @param contentFull Whether the content fills the page (if not filled, it will be automatically determined through canScrollUp)
     * @return whether it can be refreshed
     */
    public static boolean canLoadMore(@NonNull View targetView, PointF touch, boolean contentFull) {
        ...
        //canLoadMore will not search dynamically recursively when touch == null
...
//        final boolean isInView = pointInView(child, point[0], point[1], 0);
    ...
    /**
     * Convert the unit of dp to px (pixel) according to the resolution of the mobile phone
     * @param dpValue virtual pixel
     * @return pixels
     */
    ...
    /**
     * Convert the unit of px (pixel) to dp according to the resolution of the mobile phone
     * @param pxValue pixels
     * @return virtual pixel
     */
